...
| <img src="./src/assets/favicon/maskable-icon-192x192.png" width="192">        | `safari-pinned-tab.svg`             | 192x192    | .png     |
| <img src="./src/assets/favicon/maskable-icon-512x512.png" width="512">        | `safari-pinned-tab.svg`             | 512x512    | .png     |
