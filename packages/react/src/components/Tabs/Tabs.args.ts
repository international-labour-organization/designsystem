...
const fiveItems: TabsProps = {
  items: [
    ...
    },
    {
      ...
      component: "image",
      componentData: {
        alt: "Tab Two Image alt text",
        caption: "Tab Two Image Caption",
    ...
    },
    {
      ...
      component: "image",
      componentData: {
        alt: "Tab Three Image alt text",
        caption: "Tab Three Image Caption",
        credit: "Photo: copyright 2022 Person S. Name",
        url: [
          {
            breakpoint: 0,
    ...
    },
    {
      ...
      component: "image",
      componentData: {
        alt: "Tab Four Image alt text",
        caption: "Tab Four Image Caption",
        credit: "Photo: copyright 2022 Person S. Name",
        url: [
          {
            breakpoint: 0,
    ...
    },
    {
      ...
      component: "image",
      componentData: {
        alt: "Tab Five Image alt text",
        caption: "Tab Five Image Caption",
        credit: "Photo: copyright 2022 Person S. Name",
        url: [
          {
            breakpoint: 0,
