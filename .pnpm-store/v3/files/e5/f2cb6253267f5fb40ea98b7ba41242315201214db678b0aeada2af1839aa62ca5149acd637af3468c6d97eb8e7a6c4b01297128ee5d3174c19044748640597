...
export class TwingExtensionCore extends TwingExtension {
    ...
    getOperators() {
        return [
            new TwingOperator('not', TwingOperatorType.UNARY, 50, function (operands, lineno, columnno) {
                return new TwingNodeExpressionUnaryNot(operands[0], lineno, columnno);
            }),
            new TwingOperator('-', TwingOperatorType.UNARY, 500, function (operands, lineno, columnno) {
            ...
            new TwingOperator('or', TwingOperatorType.BINARY, 10, function (operands, lineno, columnno) {
                return new TwingNodeExpressionBinaryOr(operands, lineno, columnno);
            }),
            new TwingOperator('and', TwingOperatorType.BINARY, 15, function (operands, lineno, columnno) {
                return new TwingNodeExpressionBinaryAnd(operands, lineno, columnno);
            }),
            new TwingOperator('b-or', TwingOperatorType.BINARY, 16, function (operands, lineno, columnno) {
                return new TwingNodeExpressionBinaryBitwiseOr(operands, lineno, columnno);
            }),
            new TwingOperator('b-xor', TwingOperatorType.BINARY, 17, function (operands, lineno, columnno) {
                return new TwingNodeExpressionBinaryBitwiseXor(operands, lineno, columnno);
            }),
            new TwingOperator('b-and', TwingOperatorType.BINARY, 18, function (operands, lineno, columnno) {
                return new TwingNodeExpressionBinaryBitwiseAnd(operands, lineno, columnno);
            }),
            new TwingOperator('==', TwingOperatorType.BINARY, 20, function (operands, lineno, columnno) {
            ...
            new TwingOperator('not in', TwingOperatorType.BINARY, 20, function (operands, lineno, columnno) {
                return new TwingNodeExpressionBinaryNotIn(operands, lineno, columnno);
            }),
            new TwingOperator('in', TwingOperatorType.BINARY, 20, function (operands, lineno, columnno) {
                return new TwingNodeExpressionBinaryIn(operands, lineno, columnno);
            }),
            new TwingOperator('matches', TwingOperatorType.BINARY, 20, function (operands, lineno, columnno) {
                return new TwingNodeExpressionBinaryMatches(operands, lineno, columnno);
            }),
            new TwingOperator('starts with', TwingOperatorType.BINARY, 20, function (operands, lineno, columnno) {
                return new TwingNodeExpressionBinaryStartsWith(operands, lineno, columnno);
            }),
            new TwingOperator('ends with', TwingOperatorType.BINARY, 20, function (operands, lineno, columnno) {
                return new TwingNodeExpressionBinaryEndsWith(operands, lineno, columnno);
            }),
            new TwingOperator('..', TwingOperatorType.BINARY, 25, function (operands, lineno, columnno) {
                return new TwingNodeExpressionBinaryRange(operands, lineno, columnno);
            }),
            new TwingOperator('+', TwingOperatorType.BINARY, 30, function (operands, lineno, columnno) {
            ...
            new TwingOperator('~', TwingOperatorType.BINARY, 40, function (operands, lineno, columnno) {
                return new TwingNodeExpressionBinaryConcat(operands, lineno, columnno);
            }),
            new TwingOperator('*', TwingOperatorType.BINARY, 60, function (operands, lineno, columnno) {
            ...
            new TwingOperator('**', TwingOperatorType.BINARY, 200, function (operands, lineno, columnno) {
                return new TwingNodeExpressionBinaryPower(operands, lineno, columnno);
            }, TwingOperatorAssociativity.RIGHT),
            new TwingOperator('??', TwingOperatorType.BINARY, 300, function (operands, lineno, columnno) {
